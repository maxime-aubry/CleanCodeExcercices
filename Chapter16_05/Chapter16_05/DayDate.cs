...
namespace Chapter16_05
{
    ...
    public abstract class DayDate
    {
        ...
        public static DayDate AddMonths(int months, DayDate baseDate)
        {
            ...
            return DayDateFactory.makeDate(dd, MonthExtensions.Make(mm), yy);
        }
         ...
         *         is BEFORE the base date.
         */
        public static DayDate GetPreviousDayOfWeek(Day targetWeekday, DayDate baseDate)
        {
            // find the date...
            int adjust;
            Day baseDOW = baseDate.GetDayOfWeek();
         ...
         *         and is AFTER the base date.
         */
        public static DayDate GetFollowingDayOfWeek(Day targetWeekday, DayDate baseDate)
        {
            // find the date...
            int adjust;
            Day baseDOW = baseDate.GetDayOfWeek();
         ...
         *         CLOSEST to the base date.
         */
        public static DayDate GetNearestDayOfWeek(Day targetDOW, DayDate baseDate)
        {
            // find the date...
            int delta = (int)targetDOW - (int)baseDate.GetDayOfWeek();
        ...
        public DayDate GetEndOfCurrentMonth(DayDate baseDate)
        {
            ...
            return DayDateFactory.makeDate(last, baseDate.GetMonth(), baseDate.GetYYYY());
        }
        ...
        {
            return GetDayOfMonth() + "-" + MonthExtensions.ToString(GetMonth(), false) + "-" + GetYYYY();
        }
